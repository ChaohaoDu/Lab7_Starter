...
const RECIPE_URLS = ['https://introweb.tech/assets/json/1_50-thanksgiving-side-dishes.json',
...
self.addEventListener('install', function (event) {
   event.waitUntil(caches.open(CACHE_NAME).then(function (cache) {
      ...
      return cache.addAll([...RECIPE_URLS, './assets/scripts/main.js','./assets/scripts/RecipeCard.js']);
   }));
});
...
self.addEventListener('fetch', function (event) {
   ...
   // We will be adding all the resources not specified in the intiial cache
